...
|---|---|---|---|---|
| 内見予約・問い合わせ | `(inquiry)/contact` | `actions/contact.ts` | 対象物件(引き継ぎ)/ 種別(内見希望・空室確認・質問・来店予約・法人・採用。`?kind=` で種別を初期選択:viewing / vacancy / question / visit / corporate / recruit。これは初案の slug。config に置く・J-102)/ 希望日時 第1〜第2 | 見本 花子(賃貸部長) |
