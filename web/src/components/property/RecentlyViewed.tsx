 ...
 *
 * **送りの仕組みは `components/ui/Carousel.tsx`**(J-064 → J-065 → J-128 で共通化)。
 * ここに残すのは「何を出すか」だけ:localStorage の読み書き・表示名の辞書・カード部品(J-046)。
 */
	...
	return (
		<section aria-labelledby="recent-heading">
			<Carousel
				...
				render={(p) => <PropertyCard p={p} stationName={stationName} now={now} kindName={kindName} areaLabel={areaLabel} tagNames={tagNames} />}
			/>
		</section>
	);
}
